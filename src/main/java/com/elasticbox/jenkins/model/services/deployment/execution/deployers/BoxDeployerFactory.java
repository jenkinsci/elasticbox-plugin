...
public abstract class BoxDeployerFactory<R extends BoxDeployer, T extends AbstractBoxDeploymentContext> {
    ...
    protected static EnumMap<DeploymentType, BoxDeployerFactory> deploymentTypeMap = new EnumMap<DeploymentType, BoxDeployerFactory>(DeploymentType.class);

    public abstract R createDeployer(T context) ;

    static{
        deploymentTypeMap.put(DeploymentType.APPLICATIONBOX_DEPLOYMENT_TYPE, new ApplicationBoxDeployer.ApplicationBoxDeployerFactory());
    }
    ...
    public static <R extends BoxDeployer, T extends AbstractBoxDeploymentContext> R createBoxDeployer(T context) throws ServiceException {
        ...
        BoxDeployerFactory.logger.log(Level.SEVERE, "There is no BoxDeployer for DeploymentType: " + deploymentType.getValue());
